...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { amount: @type.amount, description: @type.description, initial_number: @type.initial_number, step: @type.step } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { amount: @type.amount, description: @type.description, initial_number: @type.initial_number, step: @type.step } }
